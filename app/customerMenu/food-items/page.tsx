...
const confirmPayment = () => {
 ...
 setTimeout(() => {
    ...
    //  ALERT AFTER SUCCESS POPUP APPEARS
    setTimeout(() => {
...
>
  ...
  {cartCount > 0 && (
    <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {foods.map((food) => (
              <Card
                key={food.id}
                className="bg-white/10 backdrop-blur-xl border-white/20 rounded-2xl shadow-xl overflow-hidden"
              >
                <CardContent className="p-2 flex flex-col h-full">
                  ...
                  <Badge className="w-fit mb-2 bg-white/20">
                    {food.category}
                  </Badge>
                  ...
                  <div className="flex justify-between items-center">
                   ...
                   <Button
                    ...
                    <Button className="mt-4 bg-pink-500 text-black hover:bg-pink-400" onClick={() => addToCart(food)} >
                        Add to Cart
                     </Button>
      ...
      {/*  ADDED - Pay Now Confirmation Popup */}
